...
import { r as reactExports, U as UserContext, j as jsxRuntimeExports, b as api, _ as __vitePreload } from "./index-Dwuq2f-n.js";
import { l as lodashExports } from "./lodash-Bk7i0Bmm.js";
...
const Usuarios = () => {
  ...
  const fetchUsers = async (query) => {
    ...
    try {
      ...
      const response = await fetch(`${"http://localhost:5000/api"}/users/search?identifier=${query}`, {
        headers: {
