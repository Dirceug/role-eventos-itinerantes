const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CurtidasButton-BKg0fkiF.js","assets/index-Cc20aRZ1.js","assets/index-BIH4TKpF.css","assets/CurtidasButton-DZ0ahqe3.css","assets/GerenciarResponsaveisModal-GFVmjTKz.js","assets/index-u924D1G7.js","assets/GerenciarResponsaveisModal-BZzyLXvc.css","assets/Navbar-CMs1aoFJ.js","assets/index-9ae71ce3-BWNZJcxD.js","assets/Navbar-C-lSoUeI.css","assets/EditarButton-BNNIeUUP.js","assets/CardapioButton-BM6JREyZ.css"])))=>i.map(i=>d[i]);
import { r as reactExports, c as React, U as UserContext, j as jsxRuntimeExports, b as api, _ as __vitePreload } from "./index-Cc20aRZ1.js";
/* empty css                      */
import { M as Modal } from "./index-u924D1G7.js";
const eventoBase = "/assets/eventoBase-BbKDMGlE.jpeg";
reactExports.lazy(() => __vitePreload(() => import("./CurtidasButton-BKg0fkiF.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const GerenciarResponsaveisModal = reactExports.lazy(() => __vitePreload(() => import("./GerenciarResponsaveisModal-GFVmjTKz.js"), true ? __vite__mapDeps([4,1,2,5,6]) : void 0));
...
const Navbar = reactExports.lazy(() => __vitePreload(() => import("./Navbar-CMs1aoFJ.js"), true ? __vite__mapDeps([7,1,2,8,9]) : void 0));
const CurtidasButton = reactExports.lazy(() => __vitePreload(() => import("./CurtidasButton-BKg0fkiF.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
reactExports.lazy(() => __vitePreload(() => import("./EditarButton-BNNIeUUP.js"), true ? __vite__mapDeps([10,1,2,11]) : void 0));
const MeusEventos = () => {
  ...
  reactExports.useEffect(() => {
    const fetchEvents = async () => {
      ...
      try {
        const response = await fetch(`${"https://rolesemfila.com.br/api"}/events`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
  ...
  const handlePedidosClick = () => {
    window.location.href = "/pedidos-barracas";
  };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "upcoming-events-container", children: events.length > 0 ? events.map((event) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "event-overlay", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "event-barracas2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
