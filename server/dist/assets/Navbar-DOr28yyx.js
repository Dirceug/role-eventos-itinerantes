const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CardapioButtonBranco-DFrWvp3U.js","assets/index-CXP7wpmU.js","assets/index-BIH4TKpF.css","assets/cardapioBranco-Cdq6HB4V.js","assets/CardapioButtonBranco-ojtdmf9f.css","assets/SaldoButtonBranco-D4fFGVPk.js","assets/SaldoButtonBranco-BoJTJFRx.css","assets/ListaPedidosButton-DVFJIelb.js","assets/ListaPedidosButton-DshhIMYw.css","assets/ListaUsuariosButton-BKSXFrQ1.js"])))=>i.map(i=>d[i]);
import { r as reactExports, U as UserContext, u as useNavigate, b as api, j as jsxRuntimeExports, L as Link, _ as __vitePreload } from "./index-CXP7wpmU.js";
import { i as getAuth, o as signOut } from "./index-e84cf44d-BcL1Y4JN.js";
const CardapioButtonBranco = reactExports.lazy(() => __vitePreload(() => import("./CardapioButtonBranco-DFrWvp3U.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const SaldoButtonBranco = reactExports.lazy(() => __vitePreload(() => import("./SaldoButtonBranco-D4fFGVPk.js"), true ? __vite__mapDeps([5,1,2,6]) : void 0));
const ListaPedidosButton = reactExports.lazy(() => __vitePreload(() => import("./ListaPedidosButton-DVFJIelb.js"), true ? __vite__mapDeps([7,1,2,3,8]) : void 0));
const ListaUsuariosButton = reactExports.lazy(() => __vitePreload(() => import("./ListaUsuariosButton-BKSXFrQ1.js"), true ? __vite__mapDeps([9,1,2,8]) : void 0));
