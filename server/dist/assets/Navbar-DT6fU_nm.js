const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CardapioButtonBranco-CeSeJ4ZF.js","assets/index-C8l_MEH7.js","assets/index-BIH4TKpF.css","assets/cardapioBranco-Cdq6HB4V.js","assets/CardapioButtonBranco-ojtdmf9f.css","assets/SaldoButtonBranco-Bc33_sUF.js","assets/SaldoButtonBranco-BoJTJFRx.css","assets/ListaPedidosButton-DMdTWv0_.js","assets/ListaPedidosButton-DshhIMYw.css","assets/ListaUsuariosButton-ujg8HF8F.js"])))=>i.map(i=>d[i]);
import { r as reactExports, U as UserContext, u as useNavigate, b as api, j as jsxRuntimeExports, L as Link, _ as __vitePreload } from "./index-C8l_MEH7.js";
import { j as getAuth, p as signOut } from "./index-9ae71ce3-D9oYUShw.js";
const CardapioButtonBranco = reactExports.lazy(() => __vitePreload(() => import("./CardapioButtonBranco-CeSeJ4ZF.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const SaldoButtonBranco = reactExports.lazy(() => __vitePreload(() => import("./SaldoButtonBranco-Bc33_sUF.js"), true ? __vite__mapDeps([5,1,2,6]) : void 0));
const ListaPedidosButton = reactExports.lazy(() => __vitePreload(() => import("./ListaPedidosButton-DMdTWv0_.js"), true ? __vite__mapDeps([7,1,2,3,8]) : void 0));
const ListaUsuariosButton = reactExports.lazy(() => __vitePreload(() => import("./ListaUsuariosButton-ujg8HF8F.js"), true ? __vite__mapDeps([9,1,2,8]) : void 0));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "navbar", children: [
    ...
    user && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "navbar-menu", children: [
      ...
      isUserMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "navbar-menu-content", onClick: (e) => e.stopPropagation(), children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/adicionar-dados-bancários", children: "Adicionar Dados Bancários" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/logout", onClick: handleLogout, children: "Logout" })
      ] })
    ] })
  ] });
