const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CurtidasButton-CoAoyYD1.js","assets/index-HoM017Nb.js","assets/index-BIH4TKpF.css","assets/CurtidasButton-DZ0ahqe3.css","assets/GerenciarResponsaveisModal-DKVMmWIG.js","assets/index-SV9eHfaA.js","assets/GerenciarResponsaveisModal-BZzyLXvc.css","assets/Navbar-BpNHedLZ.js","assets/index-9ae71ce3-D9oYUShw.js","assets/Navbar-DjX9SrpG.css","assets/EditarButton-CO9czlOH.js","assets/CardapioButton-BM6JREyZ.css"])))=>i.map(i=>d[i]);
import { r as reactExports, c as React, U as UserContext, j as jsxRuntimeExports, b as api, _ as __vitePreload } from "./index-HoM017Nb.js";
import { e as eventoBase } from "./eventoBase-jXVQ2lm8.js";
import { M as Modal } from "./index-SV9eHfaA.js";
reactExports.lazy(() => __vitePreload(() => import("./CurtidasButton-CoAoyYD1.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const GerenciarResponsaveisModal = reactExports.lazy(() => __vitePreload(() => import("./GerenciarResponsaveisModal-DKVMmWIG.js"), true ? __vite__mapDeps([4,1,2,5,6]) : void 0));
...
const EditarEventoModal = ({ isOpen, onRequestClose, eventId }) => {
  ...
  reactExports.useEffect(() => {
    const fetchEvent = async () => {
      ...
      try {
        const response = await fetch(`${"https://18.216.192.230/api"}/events/${eventId}`, {
          method: "GET",
          headers: {
...
const Navbar = reactExports.lazy(() => __vitePreload(() => import("./Navbar-BpNHedLZ.js"), true ? __vite__mapDeps([7,1,2,8,9]) : void 0));
const CurtidasButton = reactExports.lazy(() => __vitePreload(() => import("./CurtidasButton-CoAoyYD1.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const EditarButton = reactExports.lazy(() => __vitePreload(() => import("./EditarButton-CO9czlOH.js"), true ? __vite__mapDeps([10,1,2,11]) : void 0));
const MeusEventos = () => {
  ...
  reactExports.useEffect(() => {
    const fetchEvents = async () => {
      ...
      try {
        const response = await fetch(`${"https://18.216.192.230/api"}/events`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
