const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CardapioButtonBranco-ONyjEXR_.js","assets/index-BYsE5TuP.js","assets/index-BIH4TKpF.css","assets/cardapioBranco-Cdq6HB4V.js","assets/CardapioButtonBranco-ojtdmf9f.css","assets/SaldoButtonBranco-Dm3b0pBa.js","assets/SaldoButtonBranco-BoJTJFRx.css","assets/ListaPedidosButton-ht_NSmQr.js","assets/ListaPedidosButton-DshhIMYw.css","assets/ListaUsuariosButton-CTwuZQJs.js"])))=>i.map(i=>d[i]);
import { r as reactExports, U as UserContext, u as useNavigate, b as api, j as jsxRuntimeExports, L as Link, _ as __vitePreload } from "./index-BYsE5TuP.js";
import { j as getAuth, p as signOut } from "./index-9ae71ce3-D9oYUShw.js";
const CardapioButtonBranco = reactExports.lazy(() => __vitePreload(() => import("./CardapioButtonBranco-ONyjEXR_.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const SaldoButtonBranco = reactExports.lazy(() => __vitePreload(() => import("./SaldoButtonBranco-Dm3b0pBa.js"), true ? __vite__mapDeps([5,1,2,6]) : void 0));
const ListaPedidosButton = reactExports.lazy(() => __vitePreload(() => import("./ListaPedidosButton-ht_NSmQr.js"), true ? __vite__mapDeps([7,1,2,3,8]) : void 0));
const ListaUsuariosButton = reactExports.lazy(() => __vitePreload(() => import("./ListaUsuariosButton-CTwuZQJs.js"), true ? __vite__mapDeps([9,1,2,8]) : void 0));
