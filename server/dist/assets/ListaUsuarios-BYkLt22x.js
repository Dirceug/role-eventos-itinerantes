...
import { r as reactExports, U as UserContext, j as jsxRuntimeExports, b as api, _ as __vitePreload } from "./index-D8RQZEZ7.js";
import { l as lodashExports } from "./lodash-C5-bAE8Q.js";
...
const Usuarios = () => {
  ...
  const fetchUsers = async (query) => {
    ...
    try {
      ...
      const response = await fetch(`${"http://18.216.192.230"}/users/search?identifier=${query}`, {
        headers: {
