const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CurtidasButton-DpGWTdA9.js","assets/index-CXP7wpmU.js","assets/index-BIH4TKpF.css","assets/CurtidasButton-DZ0ahqe3.css","assets/GerenciarResponsaveisModal-CNrA4dX4.js","assets/index-DEyr1S0R.js","assets/GerenciarResponsaveisModal-BZzyLXvc.css","assets/Navbar-DOr28yyx.js","assets/index-e84cf44d-BcL1Y4JN.js","assets/Navbar-DjX9SrpG.css","assets/EditarButton-_RwIVv1D.js","assets/CardapioButton-BM6JREyZ.css"])))=>i.map(i=>d[i]);
import { r as reactExports, c as React, U as UserContext, j as jsxRuntimeExports, b as api, _ as __vitePreload } from "./index-CXP7wpmU.js";
import { e as eventoBase } from "./eventoBase-jXVQ2lm8.js";
import { M as Modal } from "./index-DEyr1S0R.js";
reactExports.lazy(() => __vitePreload(() => import("./CurtidasButton-DpGWTdA9.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const GerenciarResponsaveisModal = reactExports.lazy(() => __vitePreload(() => import("./GerenciarResponsaveisModal-CNrA4dX4.js"), true ? __vite__mapDeps([4,1,2,5,6]) : void 0));
...
const Navbar = reactExports.lazy(() => __vitePreload(() => import("./Navbar-DOr28yyx.js"), true ? __vite__mapDeps([7,1,2,8,9]) : void 0));
const CurtidasButton = reactExports.lazy(() => __vitePreload(() => import("./CurtidasButton-DpGWTdA9.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const EditarButton = reactExports.lazy(() => __vitePreload(() => import("./EditarButton-_RwIVv1D.js"), true ? __vite__mapDeps([10,1,2,11]) : void 0));
const MeusEventos = () => {
  ...
  reactExports.useEffect(() => {
    const fetchEvents = async () => {
      ...
      try {
        const response = await fetch(`${"http://52.14.179.20"}/events`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
