import { r as reactExports, U as UserContext, u as useNavigate, j as jsxRuntimeExports, b as api } from "./index-mRIjI52N.js";
import { l as lodashExports } from "./lodash-BA-wAlT4.js";
import { a as axios } from "./index-BSBq6A-N.js";
import { J as Joi } from "./joi-browser.min-EEZ8Kg8O.js";
import BackButton from "./BackButton-C9dR9cjX.js";
...
const EventForm = () => {
  ...
  const fetchUsers = async (query) => {
    ...
    try {
      ...
      const response = await fetch(`${"https://rolesemfila.com.br/api"}/users/search?identifier=${sanitizedQuery}`, {
        headers: {
