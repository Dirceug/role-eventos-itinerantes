const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CardapioButtonBranco-Bkj6sOZn.js","assets/index-CWX6cuis.js","assets/index-BIH4TKpF.css","assets/cardapioBranco-Cdq6HB4V.js","assets/CardapioButtonBranco-ojtdmf9f.css","assets/SaldoButtonBranco-wtZ4tR6O.js","assets/SaldoButtonBranco-BoJTJFRx.css","assets/ListaPedidosButton-DOH08Tw6.js","assets/ListaPedidosButton-DshhIMYw.css","assets/ListaUsuariosButton-Mgvv-g0A.js"])))=>i.map(i=>d[i]);
import { r as reactExports, U as UserContext, u as useNavigate, b as api, j as jsxRuntimeExports, L as Link, _ as __vitePreload } from "./index-CWX6cuis.js";
import { i as getAuth, l as signOut } from "./index-e84cf44d-C0APv3cj.js";
const CardapioButtonBranco = reactExports.lazy(() => __vitePreload(() => import("./CardapioButtonBranco-Bkj6sOZn.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const SaldoButtonBranco = reactExports.lazy(() => __vitePreload(() => import("./SaldoButtonBranco-wtZ4tR6O.js"), true ? __vite__mapDeps([5,1,2,6]) : void 0));
const ListaPedidosButton = reactExports.lazy(() => __vitePreload(() => import("./ListaPedidosButton-DOH08Tw6.js"), true ? __vite__mapDeps([7,1,2,3,8]) : void 0));
const ListaUsuariosButton = reactExports.lazy(() => __vitePreload(() => import("./ListaUsuariosButton-Mgvv-g0A.js"), true ? __vite__mapDeps([9,1,2,8]) : void 0));
