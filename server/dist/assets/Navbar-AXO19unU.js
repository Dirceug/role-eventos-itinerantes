const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CardapioButtonBranco-D5gIKM5g.js","assets/index-Chp7mPQo.js","assets/index-BIH4TKpF.css","assets/cardapioBranco-Cdq6HB4V.js","assets/CardapioButtonBranco-ojtdmf9f.css","assets/SaldoButtonBranco-B6y6vgXT.js","assets/SaldoButtonBranco-BoJTJFRx.css","assets/ListaPedidosButton-wPRFW0JL.js","assets/ListaPedidosButton-DshhIMYw.css","assets/ListaUsuariosButton-BUWqejdo.js"])))=>i.map(i=>d[i]);
import { r as reactExports, U as UserContext, u as useNavigate, b as api, j as jsxRuntimeExports, L as Link, _ as __vitePreload } from "./index-Chp7mPQo.js";
import { h as getAuth, n as signOut } from "./index-e84cf44d-BHhhIDao.js";
const CardapioButtonBranco = reactExports.lazy(() => __vitePreload(() => import("./CardapioButtonBranco-D5gIKM5g.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const SaldoButtonBranco = reactExports.lazy(() => __vitePreload(() => import("./SaldoButtonBranco-B6y6vgXT.js"), true ? __vite__mapDeps([5,1,2,6]) : void 0));
const ListaPedidosButton = reactExports.lazy(() => __vitePreload(() => import("./ListaPedidosButton-wPRFW0JL.js"), true ? __vite__mapDeps([7,1,2,3,8]) : void 0));
const ListaUsuariosButton = reactExports.lazy(() => __vitePreload(() => import("./ListaUsuariosButton-BUWqejdo.js"), true ? __vite__mapDeps([9,1,2,8]) : void 0));
