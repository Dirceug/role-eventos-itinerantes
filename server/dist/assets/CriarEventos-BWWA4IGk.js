import { r as reactExports, U as UserContext, u as useNavigate, j as jsxRuntimeExports, b as api } from "./index-D8RQZEZ7.js";
import { l as lodashExports } from "./lodash-C5-bAE8Q.js";
import { a as axios } from "./index-BSBq6A-N.js";
import { J as Joi } from "./joi-browser.min-CDwWtvfI.js";
import BackButton from "./BackButton-CDAvCqFD.js";
...
const EventForm = () => {
  ...
  const fetchUsers = async (query) => {
    ...
    try {
      ...
      const response = await fetch(`${"http://18.216.192.230"}/users/search?identifier=${sanitizedQuery}`, {
        headers: {
