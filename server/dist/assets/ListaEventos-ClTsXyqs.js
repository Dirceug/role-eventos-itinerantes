const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Navbar-CMs1aoFJ.js","assets/index-Cc20aRZ1.js","assets/index-BIH4TKpF.css","assets/index-9ae71ce3-BWNZJcxD.js","assets/Navbar-C-lSoUeI.css","assets/CurtidasButton-BKg0fkiF.js","assets/CurtidasButton-DZ0ahqe3.css","assets/CardapioButton-BYtdWI5L.js","assets/CardapioButton-BM6JREyZ.css"])))=>i.map(i=>d[i]);
import { r as reactExports, U as UserContext, u as useNavigate, b as api, j as jsxRuntimeExports, _ as __vitePreload } from "./index-Cc20aRZ1.js";
/* empty css                      */
...
const CardapioButton = reactExports.lazy(() => __vitePreload(() => import("./CardapioButton-BYtdWI5L.js"), true ? __vite__mapDeps([7,1,2,8]) : void 0));
const ListaEventos = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Carregando..." }), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "upcoming-events-container", children: events.map((event) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        className: "event",
        style: { backgroundImage: `url(stateImage})` },
