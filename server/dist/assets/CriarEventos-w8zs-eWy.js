import { r as reactExports, U as UserContext, u as useNavigate, j as jsxRuntimeExports, b as api } from "./index-C8l_MEH7.js";
import { l as lodashExports } from "./lodash-DVAQmEdS.js";
import { a as axios } from "./index-BSBq6A-N.js";
import { J as Joi } from "./joi-browser.min-DT_RmYUN.js";
import BackButton from "./BackButton-BZMYocyN.js";
...
const EventForm = () => {
  ...
  const fetchUsers = async (query) => {
    ...
    try {
      ...
      const response = await fetch(`${"http://18.216.192.230/api"}/users/search?identifier=${sanitizedQuery}`, {
        headers: {
