import { r as reactExports, U as UserContext, u as useNavigate, j as jsxRuntimeExports, b as api } from "./index-BYsE5TuP.js";
import { l as lodashExports } from "./lodash-BhISk2St.js";
import { a as axios } from "./index-BSBq6A-N.js";
import { J as Joi } from "./joi-browser.min-kMCwmLIL.js";
import BackButton from "./BackButton-BRfddWVl.js";
...
const EventForm = () => {
  ...
  const fetchUsers = async (query) => {
    ...
    try {
      ...
      const response = await fetch(`${"http://localhost:5000/api"}/users/search?identifier=${sanitizedQuery}`, {
        headers: {
