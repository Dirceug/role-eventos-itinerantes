import { g as requireReact, h as getAugmentedNamespace, i as requireReactDom, k as getDefaultExportFromCjs } from "./index-CWX6cuis.js";
var lib = { exports: {} };
var Modal$1 = {};
...
function requireModal() {
  ...
  var Modal2 = function(_Component) {
    _inherits(Modal22, _Component);
    function Modal22() {
      var _ref;
      var _temp, _this, _ret;
      _classCallCheck(this, Modal22);
      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Modal22.__proto__ || Object.getPrototypeOf(Modal22)).call.apply(_ref, [this].concat(args))), _this), _this.removePortal = function() {
        ...
        var portal = createPortal(_this, _react2.default.createElement(_ModalPortal2.default, _extends({ defaultStyles: Modal22.defaultStyles }, props)), _this.node);
        _this.portalRef(portal);
      }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    _createClass(Modal22, [{
      key: "componentDidMount",
      value: function componentDidMount() {
      ...
      value: function render() {
        ...
        return createPortal(_react2.default.createElement(_ModalPortal2.default, _extends({
          ref: this.portalRef,
          defaultStyles: Modal22.defaultStyles
