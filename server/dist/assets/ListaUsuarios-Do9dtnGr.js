...
import { r as reactExports, U as UserContext, j as jsxRuntimeExports, b as api, _ as __vitePreload } from "./index-HoM017Nb.js";
...
const Usuarios = () => {
  ...
  const fetchUsers = async (query) => {
    ...
    try {
      ...
      const response = await fetch(`${"https://18.216.192.230/api"}/users/search?identifier=${query}`, {
        headers: {
