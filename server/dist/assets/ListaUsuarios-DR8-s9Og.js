...
import { r as reactExports, U as UserContext, j as jsxRuntimeExports, b as api, _ as __vitePreload } from "./index-mRIjI52N.js";
...
const Usuarios = () => {
  ...
  const fetchUsers = async (query) => {
    ...
    try {
      ...
      const response = await fetch(`${"https://rolesemfila.com.br/api"}/users/search?identifier=${query}`, {
        headers: {
